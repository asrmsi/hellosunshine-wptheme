...
function staunch_setup() {
	...
	register_nav_menus( array(
		...
		'social' => __( 'Social Media Menu', 'staunch' ),
	) );
...
function staunch_scripts() {
	wp_enqueue_style( 'staunch-font', 'http://fonts.googleapis.com/css?family=Quicksand:400,700,300' );
...
/*
function undo_script_cruft() {
	wp_deregister_script( 'jquery' );
}

// Hook into the 'wp_enqueue_scripts' action
add_action( 'wp_enqueue_scripts', 'undo_script_cruft' );*/
/**
 * Body Classes
 */
